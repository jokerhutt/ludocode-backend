...
INSERT INTO ludo_user (
    ...
    time_zone
             ...
             '598ccbea-4957-4569-81cb-ea901b62c329', -- DEMO_USER_ID
             'Demo',
             'User',
             'demo@ludocode.app',
             null,
...
INSERT INTO external_account (
    ...
    provider_user_id
             ...
             '598ccbea-4957-4569-81cb-ea901b62c329', -- DEMO_USER_ID
             '598ccbea-4957-4569-81cb-ea901b62c329',
             'DEMO',
             '598ccbea-4957-4569-81cb-ea901b62c329'
         )
ON CONFLICT (id) DO NOTHING;

INSERT INTO course (id, title, img_src, request_hash) VALUES (
                '75975805-3f02-43c2-9106-c990d944dfd2',
                    'Python',
                    NULL,
                    '6873b087-9f85-4f1d-8bc9-04a84e704a29'
                                                             )
ON CONFLICT (id) DO NOTHING;

INSERT INTO module(id, title, order_index, is_deleted, course_id) VALUES (
                    'a99d4abd-895f-4a4b-b4ea-570fac609f6f',
                    'Hello World!',
                        1,
                        false,
                    '75975805-3f02-43c2-9106-c990d944dfd2'
...
INSERT INTO lesson(id, title, is_deleted) VALUES (
        '7eeaaddd-2d87-495e-bd40-24cfd9f06b4b',
            'Print Statements',
            false
                                                 )
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO exercise(id, version_number, exercise_type, title, subtitle, prompt, is_deleted, exercise_media) VALUES (
             'fd00de96-49ef-4bed-8bd7-2a05ff1b1393',
             1,
             'INFO',
             'Welcome to the Ludocode Python course!',
             'It appears you have used the docker postgres. To edit this and other courses, check out the builder!',
             '',
             false,
             NULL);

INSERT INTO exercise(id, version_number, exercise_type, title, subtitle, prompt, is_deleted, exercise_media) VALUES (
            'c8229944-d5f1-4e67-b9b3-87b9c9e90852',
            1,
            'CLOZE',
...
INSERT INTO option_content(id, content) VALUES (
            '6b44be8f-da0b-43be-8bfd-1230e25b8476',
                '+'
                                               );

INSERT INTO option_content(id, content) VALUES (
           '10012de8-3869-4c57-bcb9-bccba11de2e3',
           '='
                                               );

INSERT INTO exercise_option(id, exercise_id, exercise_version, option_id, answer_order) VALUES (
            '2288b789-9ff4-4c68-8ca8-b33defc74b3a',
            'c8229944-d5f1-4e67-b9b3-87b9c9e90852',
            1,
            '6b44be8f-da0b-43be-8bfd-1230e25b8476',
            1
...
INSERT INTO exercise_option(id, exercise_id, exercise_version, option_id, answer_order) VALUES (
           '9ccac67a-dc70-49bd-bfcd-5eeca95d61ad',
           'c8229944-d5f1-4e67-b9b3-87b9c9e90852',
           1,
           '10012de8-3869-4c57-bcb9-bccba11de2e3',
            NULL
...
INSERT INTO lesson_exercises (lesson_id, exercise_id, exercise_version, order_index) VALUES (
               '7eeaaddd-2d87-495e-bd40-24cfd9f06b4b',
               'fd00de96-49ef-4bed-8bd7-2a05ff1b1393',
                1,
                1
...
INSERT INTO user_preferences (user_id, has_experience, chosen_path) VALUES (
               '598ccbea-4957-4569-81cb-ea901b62c329',
                false,
                'DATA'
                                                                           );

INSERT INTO course_progress (user_id, course_id, current_lesson_id, is_complete)
VALUES (
           '598ccbea-4957-4569-81cb-ea901b62c329',
           '75975805-3f02-43c2-9106-c990d944dfd2',
           '7eeaaddd-2d87-495e-bd40-24cfd9f06b4b',
