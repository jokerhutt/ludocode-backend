...
//            CourseProgress(id = CourseProgressId(user1.id!!, python.id!!), currentLessonId = lesson1.id),
//            CourseProgress(id = CourseProgressId(user1.id!!, swift.id!!), currentLessonId = swiftModuleLessons[2].id)
//        ))
//
...
//
//            val progressList = courseProgressRepository.saveAll(listOf(
//                CourseProgress(id = CourseProgressId(user1.id!!, python.id!!), currentLessonId = pyModule2Lessons[2].id),
//                CourseProgress(id = CourseProgressId(user1.id!!, swift.id!!), currentLessonId = swiftModuleLessons[2].id)
//            ))
//
