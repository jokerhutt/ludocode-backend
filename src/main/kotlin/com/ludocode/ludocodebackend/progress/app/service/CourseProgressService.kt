...
class CourseProgressService(
    ...
    internal fun resetUserCourseProgress(userId: UUID, courseId: UUID): CourseProgressResponse {
        ...
        val courseProgress = courseProgressRepository.findById(CourseProgressId(userId, courseId))
            .orElseThrow { ApiException(ErrorCode.COURSE_PROGRESS_NOT_FOUND) }
    ...
    internal fun updateLesson(userId: UUID, courseId: UUID, currentLessonId: UUID): CourseProgressWithCompletion? {
        ...
        val courseProgressStats =
            courseProgressRepository.findSingleCourseStats(userId, courseId) ?: throw ApiException(
    ...
    private fun findCourseProgress(userId: UUID, courseId: UUID): CourseProgressResponse {
        return courseProgressMapper.toCourseProgressResponse(
            courseProgressRepository.findById(
                CourseProgressId(
                    userId,
                    courseId
                )
