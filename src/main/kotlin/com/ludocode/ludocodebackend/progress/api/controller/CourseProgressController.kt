...
class CourseProgressController(private val courseProgressService: CourseProgressService) {
    ...
    fun getProgressStatsByCourseIds(
        @RequestParam courseIds: List<UUID>,
        @AuthenticationPrincipal(expression = "userId") userId: UUID
    ): ResponseEntity<List<CourseProgressStats>> {
    ...
    fun resetUserCourseProgress(
        @PathVariable courseId: UUID,
        @AuthenticationPrincipal(expression = "userId") userId: UUID
    ): ResponseEntity<CourseProgressResponse> {
