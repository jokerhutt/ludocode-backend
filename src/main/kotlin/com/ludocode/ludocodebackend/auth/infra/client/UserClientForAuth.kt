...
class UserClientForAuth(
    ...
    override fun findOrCreate(req: FindOrCreateUserRequest): UserResponse {
        ...
        val url = "$userServiceBaseUrl${InternalPathConstants.IUSERS}${InternalPathConstants.IUSERS_FIND_CREATE}"
    ...
    override fun getById(id: UUID): UserResponse {
        val url = "$userServiceBaseUrl${InternalPathConstants.IUSERS}/$id"
