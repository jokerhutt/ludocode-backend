...
class ProjectMapper (private val basicMapper: BasicMapper, private val languagesMapper: LanguagesMapper) {
    ...
    fun toProjectSnapshot(projectId: UUID, projectName: String, projectLanguage: CodeLanguages, updatedAt: OffsetDateTime?, projectFiles: List<ProjectFile>, fileContentMap: Map<String, String>) : ProjectSnapshot {
        return ProjectSnapshot(projectId, projectName, languagesMapper.toLanguageMetadata(language = projectLanguage), updatedAt, toProjectFileSnapshotList(projectFiles, fileContentMap))
    }
